...
function contact(event) {
  ...
  emailjs
    ...
    .catch(() => {
      loading.classList.remove("modal__overlay--visible");
      alert(
        "The email service is temporarily unavailable. Please contact me directly on faizanfarooq000@gmail.com"
      );
    });
}
...
const textE1 = document.querySelector(".rubber__band");
